 ...
 * This comes from https://codentrick.com/part-4-android-recyclerview-grid/
 * it handles determining the number of columns in the poster grid and sizing it appropriately for
